...
String deleteFile(const std::string &command, const std::string &filePath) {
	char buffer[1024];

    std::string newPath = convert_windows_to_linux_path(filePath);

	std::string message = command + " " + newPath;
